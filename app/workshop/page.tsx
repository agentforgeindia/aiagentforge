  ...
  const SectionWrap = ({
    ...
    <section className="mx-auto max-w-7xl px-4 py-12 md:px-8">
      <div className="mb-8 text-center">
        ...
        <h2 className="mx-auto mt-3 max-w-4xl text-2xl font-black tracking-tight sm:text-3xl md:text-5xl">
          {title}
        </h2>
      </div>
      {children}
...
>
  <div className="grid items-center gap-8 md:grid-cols-[0.95fr_1.2fr]">
    ...
    <div className="p-2 text-center md:text-left">
      ...
      <h3 className="bg-gradient-to-r from-cyan-500 via-blue-600 to-violet-700 bg-clip-text text-2xl font-black leading-tight text-transparent sm:text-3xl md:text-4xl">
  ...
  <CenterCTA />
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 text-center md:px-8">
        <div className="rounded-[2.5rem] bg-gradient-to-r from-cyan-500 via-blue-600 to-violet-700 p-8 text-white shadow-2xl shadow-violet-300/30 md:p-12">
          <h2 className="text-2xl font-black sm:text-3xl md:text-5xl lg:text-6xl">
...
<div className="mt-4 text-center">
  <p className="bg-gradient-to-r from-cyan-500 via-blue-600 to-violet-600 bg-clip-text text-lg font-black uppercase tracking-[0.22em] text-transparent">
    The textile industry is changing fast. Be early.
      ...
      <a
        href={WHATSAPP_LINK}
        className="fixed bottom-20 left-1/2 z-40 hidden -translate-x-1/2 rounded-full bg-gradient-to-r from-cyan-500 via-blue-600 to-violet-700 px-6 py-4 text-sm font-black text-white shadow-2xl md:block md:bottom-6"
      >
        Register Now
      </a>
      ...
      <div className="fixed bottom-20 right-4 z-[60] flex flex-col items-center gap-1.5 md:bottom-6 md:right-6">
        <button
          type="button"
          onClick={toggleAudio}
