              ...
              {showProfile && (
                ...
                >
                  ...
                  <div className="py-2 px-2 text-sm font-semibold">
                    ...
                    <Link href="/team" className={`flex items-center gap-3 rounded-xl px-4 py-3 transition-colors ${darkMode ? "hover:bg-white/8" : "hover:bg-cyan-50 text-black/80 hover:text-cyan-600"}`}>
                      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-400/10 text-violet-500">
              ...
              <div className={`mt-2 border-t pt-3 ${darkMode ? "border-white/10" : "border-black/10"}`}>
                {isLoggedIn ? (
                  <>
                    ...
                    <Link href="/team" className="block rounded-2xl px-4 py-3 hover:bg-cyan-400/10">
                      My Team
                    </Link>
