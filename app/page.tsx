...
type SocialPlatform = {
   ...
   * "youtube"   → YouTube uploads playlist iframe (needs channel uploads playlist id, e.g. UUxxxx).
   * "none"      → fallback (LinkedIn personal /in/ profiles aren't iframe-embeddable).
   */
  embed:
      ...
      <div className="relative z-10">
        <section className="relative mx-auto max-w-6xl px-4 py-12 text-center sm:px-5 sm:py-20 md:py-24">
          ...
          <h1 className="mx-auto max-w-4xl text-[28px] font-black leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            <span className="block">AI Textile Mockup &amp;</span>
            <span className="block">Product Photography Platform</span>
          ...
          <p className={`mx-auto mt-5 max-w-2xl text-sm leading-7 sm:mt-6 sm:text-base sm:leading-8 ${muted}`}>
            ...
            catalogue-ready product photography, and ad creatives — without
            expensive models, studios, or traditional photoshoots.
          </p>
