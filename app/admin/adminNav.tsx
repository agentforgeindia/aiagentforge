...
export const TILES: Tile[] = [
  ...
  { group: "Sales & CRM", href: "/admin/onsite-training", label: "On-Site Training", description: "7/8/9 July bookings — Pune/Satara/Kolhapur showroom visits, confirm & track.", icon: <Video className="h-4 w-4" />,           perm: "leads.view" },
