...
export const TILES: Tile[] = [
  ...
  { group: "Sales & CRM", href: "/admin/workshop-failed", label: "Failed Payments", description: "Incomplete ₹99 workshop payments — resend the payment link on WhatsApp.", icon: <PhoneCall className="h-4 w-4" />, perm: "customers.view" },
