...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // ============================================================
  // ACADEMY / CAREERS — 3 posts
  // ============================================================
  {
    slug: "work-from-home-jobs-india-agentforge-academy",
    title: "Work From Home Jobs 2026: AgentForge Academy Is Hiring Across India",
    description:
      "AgentForge Academy is hiring telecallers, AI operators, lead researchers and social media executives across India — 100% work from home, ₹5,000 basic salary + incentives, free training provided.",
    excerpt:
      "No office. No commute. No experience required. AgentForge Academy is building India's largest remote AI sales team — and hiring right now from every city and town.",
    keywords: [
      ...
      "AgentForge Academy jobs",
      "remote jobs India 2026",
      "work from home salary 5000",
    ],
    category: "Announcement",
    author: "AgentForge Team",
    ...
    heroEmoji: "🏠",
    thumbnail: {
      headline: "WFH Jobs 2026",
      subline: "AgentForge Academy",
      badge: "Now Hiring",
      gradientFrom: "#06b6d4",
      gradientTo: "#7c3aed",
      icon: "🏠",
      statsRow: ["₹5,000 Basic", "100% WFH", "Free Training"],
    },
    ...
    body: [
      {
        type: "p",
        text: "AgentForge AI — India's AI Visual Studio — is building a 100-member remote team in 2026. The Learn & Earn Academy is now open for applications across India. No office required, no prior experience mandatory, and training is completely free.",
      },
      { type: "h2", text: "What is AgentForge Academy?" },
      {
        type: "p",
        text: "AgentForge Academy is a work-from-home hiring program where candidates learn AI sales and support skills online, take a short assessment, and get hired for remote work. Every selected member receives a ₹5,000 basic salary per month plus performance incentives on top.",
      },
      { type: "h2", text: "Open Roles" },
      { type: "ul", items: [
        "Telecaller — ₹5,000 basic + per sale incentive",
        "Lead Research Executive — ₹5,000 basic + target-based incentive",
        "Social Media Executive — ₹5,000 basic + performance-based incentive",
        "AI Operator — ₹5,000 basic + output-based incentive",
        "Customer Support Executive — ₹5,000 basic + CSAT-based incentive",
      ]},
      { type: "h2", text: "Who can apply?" },
      { type: "ul", items: [
        "Anyone from India — any city, town or village",
        "Freshers welcome — no prior experience required",
        "Minimum education: 10th pass",
        "Must have a smartphone and basic internet connection",
        "Available for at least 4 hours per day",
      ]},
      { type: "h2", text: "What is the hiring process?" },
      { type: "ul", items: [
        "Step 1: Register online at aiagentforge.in/careers (free, 2 minutes)",
        "Step 2: Complete free training modules on the learning portal",
        "Step 3: Take a 30-minute online assessment (English, Communication, Sales, AI topics)",
        "Step 4: Team calls for a short interview",
        "Step 5: Get hired, receive work assignments and earn",
      ]},
      { type: "h2", text: "What training is provided?" },
      { type: "ul", items: [
        "Module 1: AgentForge Introduction — company, products, mission",
        "Module 2: Communication Training — WhatsApp, email, calling",
        "Module 3: Lead Handling — qualifying and following up",
        "Module 4: AI Product Training — how to demo and sell AI tools",
        "Module 5: CRM Training — lead update and tracking",
        "Module 6: Sales Basics — objection handling and closing",
      ]},
      { type: "quote", text: "Skills seekho. Ghar se kaam karo. Zyada kamao. AgentForge Academy mein aapka swagat hai." },
      { type: "h2", text: "Scale Vision" },
      {
        type: "p",
        text: "When the Academy reaches 100 active members — 50 telecallers, 20 lead researchers, 10 social media executives, 10 AI operators and 10 support staff — the combined business contribution target is ₹10 lakh per month. Members who perform consistently get incentives, recognition and growth within the team.",
      },
      { type: "h2", text: "How to apply" },
      {
        type: "p",
        text: "Go to aiagentforge.in/careers. Click Start Learning. Complete the free training. Take the assessment. The team will contact you within 48 hours of a passing score. No fees, no hidden charges — the entire process is free.",
      },
    ],
  },

  {
    slug: "learn-earn-academy-complete-guide-agentforge",
    title: "Learn & Earn Academy: Complete Guide to Getting Hired at AgentForge",
    description:
      "Step-by-step guide to AgentForge Learn & Earn Academy — from registration to getting your first work assignment. Training modules, assessment tips, job categories and salary structure explained.",
    excerpt:
      "Everything you need to know about AgentForge Academy — the free training program, the online assessment, the 5 job roles and exactly what you will earn once selected.",
    keywords: [
      "AgentForge Academy guide",
      "learn and earn India",
      "online work from home training",
      "WFH telecaller training India",
      "AI sales job training India",
      "free online training work India",
    ],
    category: "Guide",
    author: "AgentForge Team",
    ...
    heroEmoji: "🎓",
    thumbnail: {
      headline: "Academy Guide",
      subline: "Learn → Earn",
      badge: "Complete Guide",
      gradientFrom: "#8b5cf6",
      gradientTo: "#06b6d4",
      icon: "🎓",
      statsRow: ["6 Modules", "30-Min Test", "₹5K + Incentive"],
    },
    ...
    body: [
      {
        type: "p",
        text: "AgentForge Learn & Earn Academy is a free online training and hiring program. You learn AI sales and support skills, take a short assessment, and if selected, get paid remote work — from home, anywhere in India. This guide explains every step.",
      },
      { type: "h2", text: "Step 1: Register and choose your role" },
      {
        type: "p",
        text: "Visit aiagentforge.in/careers. You will see 5 open role categories. Click on the role that interests you — Telecaller, Lead Research, Social Media, AI Operator or Customer Support. Each role has a dedicated learning path.",
      },
      { type: "h2", text: "Step 2: Complete the training modules" },
      {
        type: "p",
        text: "The learning portal has 6 modules. Each takes 10–20 minutes to read. You can complete them at your own pace — phone or laptop, anytime.",
      },
      { type: "ul", items: [
        "Module 1 — AgentForge Introduction (10 min): what the company does, what products we sell",
        "Module 2 — Communication Training (15 min): WhatsApp, email and calling best practices",
        "Module 3 — Lead Handling (15 min): what a lead is, how to qualify and follow up",
        "Module 4 — AI Product Training (20 min): how to explain and demo AI tools to clients",
        "Module 5 — CRM Training (15 min): how to update lead status and follow-up schedules",
        "Module 6 — Sales Basics (20 min): objection handling, pricing discussion, demo booking",
      ]},
      { type: "h2", text: "Step 3: Take the 30-minute assessment" },
      {
        type: "p",
        text: "Once you have read the training modules, take the online assessment. It has 30 MCQ questions covering English grammar, communication, computer basics, internet usage, AI awareness and sales aptitude. Timer is 30 minutes. You need 50% or above to qualify.",
      },
      { type: "h3", text: "Tips to score well" },
      { type: "ul", items: [
        "Read all 6 training modules before taking the test",
        "Find a quiet place with stable internet",
        "Read every question fully before choosing an answer",
        "Do not skip — unanswered questions count against you",
        "You can navigate between questions during the test",
      ]},
      { type: "h2", text: "Step 4: Interview call" },
      {
        type: "p",
        text: "If you score 50% or above, AgentForge's team will call you within 24–48 hours for a short 10–15 minute phone or video interview. This checks your communication, availability and interest level.",
      },
      { type: "h2", text: "Step 5: Get hired and receive work" },
      {
        type: "p",
        text: "Selected candidates receive their first work assignment within 72 hours. Work is assigned based on your role and availability. All work is completed from home — calls, lead research, social media, AI demo support or customer queries.",
      },
      { type: "h2", text: "What you will earn" },
      { type: "ul", items: [
        "Basic salary: ₹5,000 per month for all roles",
        "Telecaller incentive: per confirmed sale — typical range ₹200–₹1,000 per sale",
        "Lead researcher incentive: per qualified lead delivered",
        "Social media incentive: based on content performance metrics",
        "AI operator incentive: per generation/task completed",
        "Support incentive: based on customer satisfaction score",
      ]},
      { type: "quote", text: "Training padho, test do, interview do — aur ghar se kaam karte hue kamao. Itna simple hai." },
      { type: "h2", text: "Frequently asked questions" },
      { type: "h3", text: "Is there any fee?" },
      { type: "p", text: "No. Registration, training and the assessment are completely free. AgentForge never charges candidates." },
      { type: "h3", text: "What if I fail the assessment?" },
      { type: "p", text: "You can re-attempt after studying the modules again. The team will notify you with guidance on which areas to improve." },
      { type: "h3", text: "Can students apply?" },
      { type: "p", text: "Yes. If you are available for 4+ hours per day and have basic communication skills, you are eligible. Many current members started as students." },
    ],
  },

  {
    slug: "ai-sales-career-india-agentforge-telecaller",
    title: "AI Sales Career in India 2026: Why Telecallers Are Choosing AgentForge",
    description:
      "Why AI sales is the fastest growing work-from-home career in India — and why telecallers with basic skills are earning ₹8,000–₹20,000 per month from home through AgentForge Academy.",
    excerpt:
      "AI product sales is the new high-growth WFH career in India. Telecallers who sell AI tools are earning 2–3x more than traditional BPO callers — and the demand is only going up.",
    keywords: [
      "AI sales career India",
      "telecaller work from home India",
      "AI sales job India 2026",
      "WFH telecaller salary India",
      "online sales job India",
      "AgentForge telecaller",
      "AI product sales India",
    ],
    category: "Guide",
    author: "AgentForge Team",
    publishedAt: "2026-06-03T00:00:00.000Z",
    ...
    heroEmoji: "📞",
    thumbnail: {
      headline: "AI Sales Career",
      subline: "WFH India 2026",
      badge: "High Growth Role",
      gradientFrom: "#0ea5e9",
      gradientTo: "#10b981",
      icon: "📞",
      statsRow: ["₹8K–₹20K/Month", "WFH Only", "AI Product Sales"],
    },
    ctaLabel: "Apply for Telecaller Role",
    ctaHref: "/careers",
    body: [
      {
        type: "p",
        text: "Traditional BPO telecalling pays ₹8,000–₹12,000 per month in a call centre, 9 hours a day, 6 days a week. AI product telecalling at AgentForge pays the same basic salary — but you work from home, choose your hours, and earn incentives per sale that can double or triple your take-home.",
      },
      { type: "h2", text: "Why AI products are easier to sell than you think" },
      {
        type: "p",
        text: "Most people assume selling AI requires technical knowledge. It does not. The buyer — a saree seller in Surat or a jeweller in Jaipur — wants to know one thing: will this save me money and time? Your job is to show them the before and after, book a live demo, and close. The product sells itself once the buyer sees it.",
      },
      { type: "h2", text: "A typical day for an AgentForge telecaller" },
      { type: "ul", items: [
        "9 AM: Review today's lead list on the CRM",
        "9:30 AM–1 PM: Make calls — qualify leads, book demo slots",
        "1 PM: Break and lunch",
        "2 PM–5 PM: Follow-up calls, WhatsApp messages, lead updates",
        "5 PM: End of day report to team lead",
        "Total: 6–7 hours, from home",
      ]},
      { type: "h2", text: "What a good month looks like" },
      { type: "ul", items: [
        "Basic salary: ₹5,000",
        "10 confirmed sales × ₹500 incentive = ₹5,000",
        "Total month 1 (learning phase): ₹10,000",
        "Experienced caller, 25 sales/month: ₹5,000 + ₹12,500 = ₹17,500",
        "Top performers (40+ sales/month): ₹5,000 + ₹20,000+ = ₹25,000+",
      ]},
      { type: "quote", text: "Main pehle ek local BPO mein kaam karta tha. AgentForge mein aake pehle mahine se hi zyada kama raha hun — aur ghar se." },
      { type: "h2", text: "Skills that make the difference" },
      { type: "ul", items: [
        "Clear Hindi or English communication (Hinglish is fine)",
        "Patience — most sales happen on the 3rd to 5th follow-up",
        "Product knowledge — completed training modules are essential",
        "CRM discipline — every call updated in the system",
        "Positive energy — buyers feel it in the first 10 seconds",
      ]},
      { type: "h2", text: "Why AI product sales is different from BPO" },
      { type: "ul", items: [
        "You are not reading from a script — you are solving a real problem",
        "The product has genuine demand — Indian businesses need AI catalogues",
        "Incentives are unlimited — no cap on how much you can earn",
        "You build real sales skills, not just call volume",
        "Remote work means zero commute cost",
      ]},
      { type: "h2", text: "How to get started" },
      {
        type: "p",
        text: "Apply at aiagentforge.in/careers. Complete the Telecaller training path (6 modules, 1–2 hours). Take the 30-minute assessment. Score 50% or above and the team calls you. First work assignment in 72 hours.",
      },
    ],
  },
];
